    ...
    *num = 0;
    ...
    while (fgets(line, 80, fp1) != NULL)
    {
        ...
        i++;
            ...
            /* keep track of how many people there are being read from the file and being inserted into the array 'people' */
        (*num)++;
...
void printArray(Info identity[], int n)
{
    ...
    printf("\nGoing to print people info that was read from the file and stored into an array.\n");
